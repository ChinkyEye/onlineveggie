    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                ...
                <button type="button" class="btn btn-sm bg-gradient-primary" data-toggle="modal" data-target="#customerCreditor">
                    Add Creditor Customer
                </button>
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped w-100 my-table" id="creditor_customer_ajax">
            ...
            <!-- /.card-body -->
            <!-- Modal -->
            <div class="modal fade" id="customerCreditor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form role="form" method="POST" action="{{route('admin-customer-creditor-store')}}">
...
<script type="text/javascript">
    $('#creditor_customer_ajax').DataTable({
        "processing": true,
        "language": {
        ...
        "serverSide": true,
        "ajax":{
            "url": "{{route('admin-getAllCreditor')}}",
            "dataType": "json",
            "type": "POST",
            "data":{ 
                _token: $(".token").val(),
