    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <a href="{{route('admin-customer-report')}}" class="dropdown-item">
                    <div class="media">
                ...
                <div class="dropdown-divider"></div>
                <a href="{{route('admin-stock-report')}}" class="dropdown-item">
                    <div class="media">
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
                ...
                <div class="dropdown-divider"></div>
                <a href="{{route('admin-sales-report')}}" class="dropdown-item">
                    <div class="media">
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
                ...
                <div class="dropdown-divider"></div>
                <a href="{{route('admin-purchase-report')}}" class="dropdown-item">
                    <div class="media">
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
                ...
                <div class="dropdown-divider"></div>
                <a href="{{route('admin-bill-report')}}" class="dropdown-item">
                    <div class="media">
                        <div class="media-body">
                            <h3 class="dropdown-item-title">
        ...
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                <a href="{{route('admin-create-branch')}}" class="dropdown-item">
                    <i class="fas fa-envelope mr-2"></i> Create Branch
                </a>
                <div class="dropdown-divider"></div>
                <a href="{{route('admin-create-manager')}}" class="dropdown-item">
                    <i class="fas fa-code-branch mr-2"></i> Manager
                </a>
                <div class="dropdown-divider"></div>
