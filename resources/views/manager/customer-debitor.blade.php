        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered table-hover table-striped my-table w-100" id="debitor_customer_ajax">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form role="form" method="POST" action="{{route('customer-debitor-store')}}">
...
<script type="text/javascript">
    $('#debitor_customer_ajax').DataTable({
        "processing": true,
        "language": {
