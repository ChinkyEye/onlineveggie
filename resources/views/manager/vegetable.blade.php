...
<link href="{{url('/')}}/backend/fileinput/css/fileinput.css" media="all" rel="stylesheet" type="text/css" />
...
<div class="row">
    <div class="col-md-12">
            <form role="form" method="POST" action="{{route('vegetable-store')}}" enctype="multipart/form-data">
            <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md">
                            <label for="image">Image</label>
                                <input id="input-b1" name="image" type="file" class="file" data-browse-on-zone-click="true"  data-show-upload="false" data-show-caption="true">
                                <small>(jpeg, jpg file format and 1 MB file size)</small>
        ...
        <div class="card">
            <div class="card-body">
                <!-- <button type="button" class="float-left btn btn-tool text-primary" data-card-widget="maximize"><i class="fas fa-expand"></i></button> -->
                <input type="hidden" name="_token" class="token" value="{{ csrf_token() }}">
...
<!--  -->
<script src="{{URL::to('/')}}/backend/fileinput/js/plugins/sortable.js" type="text/javascript"></script>
<!-- the main fileinput plugin file -->
<script src="{{url('/')}}/backend/fileinput/js/fileinput.js"></script>
