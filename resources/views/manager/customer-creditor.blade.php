            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form role="form" method="POST" action="{{route('customer-creditor-store')}}">
                                ...
                                <input type="hidden" name="_token" class="token" value="{{csrf_token()}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="address" class="form-control">
                                            @foreach($addresses as $addr=>$address)
...
<script type="text/javascript">
    $('#creditor_customer_ajax').DataTable({
        "processing": true,
        "language": {
            processing: '<i class="fas fa-tachometer-alt"></i><span class="sr-only">Techware Inventory......</span> '
        },
        "serverSide": true,
        "ajax":{
