...
class CustomerController extends Controller
{
    ...
    {
        return view('manager.report.customer');
    }
    ...
    public function search()
    {
        ...
        if($customer_type == '1'){
            $query = Order_total::orderBy('id','DESC')->where('created_by', Auth::user()->id);
            if($customer_id != ''){
            ...
            return view('manager.report.customer-search', compact(['customerquery','req_to','count','date']));
        }
    }
