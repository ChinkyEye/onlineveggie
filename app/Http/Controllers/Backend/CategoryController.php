...
class CategoryController extends Controller
{
    ...
    public function detail($slug){
        ...
        return view('backend.category-detail', compact('cat_id','slug','category'));
    }
    ...
    public function getAllCategoryDetail(Request $request){
        ...
        if(!empty($posts))
        {
            foreach ($posts as $index=>$post)
            {
                ...
                $nestedData['date'] = date("Y/M/D", strtotime($post->date)).' '.'<span class="text-primary badge badge-warning">'.$post->created_at->diffForHumans().'</span>';
